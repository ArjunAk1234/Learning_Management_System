...
function LogIn() {
  ...
  async function handleLogin(event) {
    ...
    try {
      const res = await axios.post("http://localhost:8006/auth/login", {
      ...
      if (res.data && res.data.token) {
        ...
        const otpRes = await axios.post(
          "http://localhost:8006/auth/request-otp1",
          { email: formData.email },
  ...
  const onOtpSubmit = async (otp) => {
    ...
    try {
      ...
      const verifyRes = await axios.post(
        "http://localhost:8006/auth/verify-otp1",
        { email, otp },
        headers
      );
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:8006/auth/request-otp1", {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:8006/auth/forgotpassword", {
        email: forgotPasswordEmail,
