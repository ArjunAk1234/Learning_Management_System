...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8006/courses/summary')
      .then(res => {
    ...
    axios.get('http://localhost:8006/assignments')
      .then(res => {
    ...
    axios.get('http://localhost:8006/quiz/active')
      .then(res => {
    ...
    axios.get('http://localhost:8006/leaderboard/me', {
      headers: {
